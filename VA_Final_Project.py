    ...
    while run_wake_word:
        ...
        while run:
            ...
            if 'wake up' in va.text:
                ...
                if emo_state == "anger":
                    ques = "Hey, It seems like you're feeling upset. I'm here for you. Do you want to watch a movie or particiapte in an activity?"
                elif emo_state == "fear":
                    ques = "Oh no, something's scaring you. It's okay, I'm here. Want to watch a movie or do an activity to help you feel better?"
                elif emo_state == "joy":
                    ques = "Hey, you seem happy! It's great to see. Let's keep it going. Can I recommend you a movie to watch or an activity?"
                elif emo_state == "sadness":
                    ques = "It seems like you're feeling down. I'm here if you need me. Can I recommend you a movie to watch or an activity to lift your spirit?"
                else:
                            ...
                            if va.yes_no_question(va.text):
                                ...
                                if not va.sentiment_detection(va.text):
                                    if count_movie == 0:
                                        ...
                                        ques = "Do you want me to recommend you an activity instead?"
                                        va.ask_to_user(f"""{ques}""")
                                        if va.yes_no_question(va.text):
